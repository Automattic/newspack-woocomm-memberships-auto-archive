...
class WooCommPostAutoArchiveSettingsPanel extends Component {
  ...
  render() {
    const { postPublishDate, onMetaChange, isSavingPost, meta } = this.props;
    const minDaysToAutoArchive = this.getMinDaysToAutoArchive( postPublishDate );
      ...
      >
        <ToggleControl
          ...
          onChange={ toggled => {
            ...
            toggleForcePublicCheckbox( meta.newspack_woocomm_post_auto_archive );
          } }
          checked={ meta.newspack_woocomm_post_auto_archive }
        ...
        <TextControl
          ...
          onChange={ value => {
            onMetaChange( {
              newspack_woocomm_days_to_auto_archive: value < minDaysToAutoArchive ? minDaysToAutoArchive : value
            } );
          } }
